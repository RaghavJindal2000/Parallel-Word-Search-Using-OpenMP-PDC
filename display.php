  ...
  <div class="container contentContainer" id="topContainer">
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3" id="topRow">
          <h1 class="marginTop lead">WordSearch</h1>

          <p class="lead">This is the web interface for the Parallel Word Search.</p>

          <p class="lead">Openmp is the underlying technology</p>
          <p class="bold marginTop lead">Interested? Check it how awesome it is!</p>
        ...
        $raw_results = mysqli_query($con,"SELECT * FROM list
            ...
            else
            {
              while($row=mysqli_fetch_array($raw_results)){
                       ...
                       $arr = array("File1.txt"=>$a,"File2.txt"=>$b,"File3.txt"=>$c,"File4.txt"=>$d,"File5.txt"=>$e);
